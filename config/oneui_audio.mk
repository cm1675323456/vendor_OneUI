...
ALARM_PATH := vendor/OneUI/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/OneUI/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/OneUI/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/OneUI/prebuilt/common/media/audio/ui
